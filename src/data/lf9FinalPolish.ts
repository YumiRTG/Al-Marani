...
function learnerText(value?: string) {
  ...
  return value
    ...
    .replace(/\bDie Lernstoff nennt\b/gi, 'Typisch sind')
    ...
    .replace(/\bDie Lernstoff beschreibt\b/gi, 'Typisch ist')
    .replace(/\bDer Lernstoff beschreibt\b/gi, 'Typisch ist')
    .replace(/\bDie Lernunterlage beschreibt\b/gi, 'Typisch ist')
    .replace(/\bDie Unterlage beschreibt\b/gi, 'Typisch ist')
    .replace(/\bDie Lernstoff nutzt\b/gi, 'Als Lernhilfe dient')
    ...
    .replace(/\bDie Lernstoff\b/g, 'Der Lerninhalt')
    .replace(/\bdie Lernstoff\b/g, 'der Lerninhalt')
    .replace(/\bder Lernstoff\b/gi, 'der Lerninhalt')
    .replace(/\bdem Lernstoff\b/gi, 'dem Lerninhalt')
