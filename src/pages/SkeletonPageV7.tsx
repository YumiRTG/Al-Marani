...
const panels: Panel[] = [
  {
    title: 'Schädel von vorne',
    subtitle: 'Die Nummern im Bild gehören direkt zu den Bezeichnungen in der Liste.',
  ...
  },
  {
    ...
    subtitle: 'Das Originalbild ist englisch beschriftet. Die deutschen und lateinischen Bezeichnungen stehen direkt daneben.',
  ...
  {
    title: 'Wirbelsäule',
    subtitle: 'Die Abschnitte der Wirbelsäule sind farblich voneinander getrennt.',
  ...
  {
    title: 'Brustkorb',
    subtitle: 'Brustbein, Rippen, Brustwirbel und Rippenknorpel im Zusammenhang.',
  ...
  },
  {
    ...
    subtitle: 'Die Grafik zeigt Schulterblatt, Oberarm, Unterarm und Hand in einer Ansicht.',
    image: IMG.arm,
    legend: [
      ['Schulterblatt', 'Scapula', 'Scapula'],
      ['Oberarmknochen', 'Humerus', 'Humerus'],
  ...
  },
  {
    ...
    subtitle: 'Vom Schlüsselbein und Schulterblatt bis zu den Fingern.',
    image: IMG.upperLimb,
    legend: [
  ...
  {
    title: 'Hand',
    subtitle: 'Die Beschriftung ist bereits deutsch. In der Liste stehen zusätzlich die lateinischen Fachbegriffe.',
  ...
  },
  {
    ...
    subtitle: 'Die Buchstaben A–H im Bild gehören zu den acht Handwurzelknochen.',
    image: IMG.carpal,
    legend: [
  ...
  {
    title: 'Becken',
    subtitle: 'Die Nummern im Bild entsprechen den Bezeichnungen in der Liste.',
    image: IMG.pelvis,
    legend: [
  ...
  {
    title: 'Bein',
    subtitle: 'Oberschenkel, Knie, Unterschenkel und Fuß in einer Übersicht.',
    image: IMG.leg,
    legend: [
      ['Oberschenkelknochen', 'Femur', 'Femur'],
  ...
  },
  {
    ...
    subtitle: 'Die lateinischen Begriffe stehen im Bild; die deutschen Bezeichnungen findest du direkt daneben.',
    image: IMG.footLatin,
    legend: [
      ['Sprungbein', 'Talus'],
  ...
  {
    title: 'Fuß von oben',
    subtitle: 'Eine zusätzliche Ansicht für Fußwurzel, Mittelfuß und Zehen.',
  ...
  return (
    <div>
      <div className="mb-3 rounded-2xl bg-teal-50 px-4 py-3 text-sm font-bold text-teal-900">
        Deutsche Bezeichnung · lateinischer Fachbegriff
      </div>
      <div className="grid gap-2 sm:grid-cols-2 xl:grid-cols-1">
        {rows.map(([de, latin, original]) => (
          <div key={`${de}-${latin}-${original ?? ''}`} className="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3">
            ...
            {original ? <div className="mt-1 text-xs text-slate-400">Im Bild: {original}</div> : null}
          </div>
        ))}
      </div>
    </div>
    ...
    <article className="overflow-hidden rounded-[30px] border border-slate-100 bg-white shadow-xl">
      ...
      <div className="grid gap-5 px-5 pb-6 sm:px-8 sm:pb-8 xl:grid-cols-[minmax(0,1.35fr)_minmax(340px,.65fr)]">
        <div className="grid min-h-[440px] place-items-center overflow-hidden rounded-[24px] border border-slate-200 bg-white p-4 sm:p-6">
          <img src={panel.image} alt={panel.title} loading="lazy" className={`max-h-[780px] max-w-full object-contain ${panel.imageClassName ?? ''}`} />
        </div>
...
export function SkeletonPageV7({ onBack }: Props) {
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_8%_0%,_#fef3c7_0,_#f8fafc_30%,_#dbeafe_100%)] text-slate-900">
      <main className="mx-auto max-w-[1320px] px-4 pt-10 pb-24 sm:px-6">
        ...
        <section className="mt-7 rounded-[34px] bg-gradient-to-br from-slate-950 via-slate-900 to-amber-950 p-8 text-white shadow-2xl sm:p-11">
          <div className="max-w-5xl">
            <div className="inline-flex items-center gap-2 rounded-full bg-amber-300/15 px-4 py-2 text-xs font-black uppercase tracking-[.16em]">
              <Languages className="h-4 w-4" /> Skelett & Fachbegriffe
            </div>
            <h1 className="mt-5 text-4xl font-black leading-[1.02] tracking-tight sm:text-6xl">
              Das menschliche Skelett
              <span className="block text-amber-300">Knochen nach Regionen im Überblick.</span>
            </h1>
            <p className="mt-5 max-w-4xl text-slate-300 leading-7 sm:text-lg">
              Zu jedem Bereich findest du eine passende anatomische Abbildung sowie die deutschen und lateinischen Bezeichnungen. Wenn ein Originalbild englisch oder nur lateinisch beschriftet ist, steht die deutsche Bezeichnung direkt daneben.
            </p>
          </div>
        </section>
        ...
        <section className="mt-9 grid gap-6 lg:grid-cols-2">
          <article className="overflow-hidden rounded-[30px] bg-white shadow-xl">
            <div className="p-6 sm:p-8">
              ...
              <h2 className="mt-2 text-2xl font-black sm:text-3xl">Skelett – Vorderansicht</h2>
              <p className="mt-2 text-sm leading-6 text-slate-600">Die wichtigsten Knochen sind direkt auf Deutsch beschriftet.</p>
            </div>
          ...
          <article className="overflow-hidden rounded-[30px] bg-white shadow-xl">
            <div className="p-6 sm:p-8">
              ...
              <h2 className="mt-2 text-2xl font-black sm:text-3xl">Skelett – Rückansicht</h2>
              <p className="mt-2 text-sm leading-6 text-slate-600">Die Originalgrafik ist englisch beschriftet; die deutschen und lateinischen Begriffe stehen direkt daneben.</p>
            </div>
        ...
        <section className="mt-11">
          ...
          <h2 className="mt-2 text-3xl font-black">Knochen nach Regionen</h2>
          <p className="mt-2 max-w-4xl text-sm leading-6 text-slate-600">
            Die einzelnen Abbildungen zeigen Schädel, Wirbelsäule, Brustkorb, Arme, Hände, Becken, Beine und Füße noch einmal genauer.
          </p>
          <div className="mt-7 grid gap-8">
            {panels.map((panel) => <PanelCard key={panel.title} panel={panel} />)}
          </div>
        </section>
        ...
        <section className="mt-11">
          ...
          <h2 className="mt-2 text-3xl font-black">Deutschsprachige Videos</h2>
